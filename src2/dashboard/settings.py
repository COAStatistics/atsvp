...
CSP_CONNECT_SRC = ("'self'", "'unsafe-inline'", 'www.google-analytics.com', 'www.googletagmanager.com')
CSP_FRAME_SRC = ("'self'", "'unsafe-inline'", 'bigdata.moa.gov.tw')
CSP_STYLE_SRC = ("'self'", "'unsafe-inline'", 'fonts.googleapis.com', 'cdn.datatables.net', 'cdnjs.cloudflare.com', 'bigdata.moa.gov.tw', 'www.google-analytics.com', 'www.googletagmanager.com')
CSP_SCRIPT_SRC = ("'self'", "'unsafe-inline'", 'ajax.googleapis.com', 'cdnjs.cloudflare.com', 'bigdata.moa.gov.tw', 'www.google-analytics.com', 'www.googletagmanager.com')
...
GA_TRACKING_ID = env.str('GA_TRACKING_ID_APSVP', default='')
...
TABLEAU_UPDATE_YEAR = env.str('APSVP_UPDATE_YEAR', default='')
TABLEAU_UPDATE_MONTH = env.str('APSVP_UPDATE_MONTH', default='')

# Web Name
WEB_NAME = env.str('APSVP_WEBNAME', default='')
