...
urlpatterns = [
    ...
    re_path(r'^tableau1/$', JavaScriptCatalog.as_view(), name='Tableau1'),
    re_path(r'^tableau2/$', JavaScriptCatalog.as_view(), name='Tableau2'),
    re_path(r'^tableau3/$', JavaScriptCatalog.as_view(), name='Tableau3'),
    re_path(r'^tableau4/$', JavaScriptCatalog.as_view(), name='Tableau4'),
    re_path(r'^tableau5/$', JavaScriptCatalog.as_view(), name='Tableau5'),
    re_path(r'^tableau6/$', JavaScriptCatalog.as_view(), name='Tableau6'),
    re_path(r'^tableau7/$', JavaScriptCatalog.as_view(), name='Tableau7'),
    re_path(r'^tableau8/$', JavaScriptCatalog.as_view(), name='Tableau8'),
